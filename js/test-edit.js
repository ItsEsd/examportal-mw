...
$("document").ready(function () {
  $("#stimg").on("change", async function () {
    ...
    if (files.length) {
      ...
      document.getElementById("qstimg").value = "uploading image...";
      const formData = new FormData();
      formData.append("image", files[0]);
      const apiUrl = "https://api.mastrowall.in/_file/image";
      try {
...
$("document").ready(function () {
  $("#opsimg").on("change", async function () {
    var files = $(this).get(0).files;
    for (var k = 0; k <= 3; k++) {
      document
    ...
    if (files.length) {
      ...
      document.getElementById("opimg").value = "uploading image...";
      const formData = new FormData();
      formData.append("image", files[0]);
      const apiUrl = "https://api.mastrowall.in/_file/image";
      try {
...
function displayQST() {
  ...
  if (
    ...
    document.getElementById("displayqst").innerHTML =
      "<center><h4 style='text-align:center;font-size:20px;padding-top:140px;'>Please complete all fields</h4></center>";
    return false;
  }
}
...
function dwnldqsetaftrexend() {
  ...
  var url1 = "https://script.google.com/macros/s/";
  var url2 =
    "AKfycby609cKn5mTtCk3F86SqLpiTYbcDtoK611N3gzFlAaAgpY5tQBk5iIEVEzebCeEMCdoxw";
  document.getElementById("loaderCon").style.display = "block";
  var urlcp =
    url1 +
    url2 +
    "/exec" +
    "?callback=prevqsetexend&chexid=" +
    exid +
    "&chkey=" +
    ekey +
    "&action=dwnldqst";
  ...
  setTimeout(function () {
    ...
    oPrntWin.document.write(
      "<!doctype html><html><head><title>" +
        ...
        elem3.innerHTML +
        '</div><hr style="max-width:1000px;"><h4><a target=\'_blank\' href="https://mastrowall.com" style="text-decoration:none;color:#0c29cd;"><b>M A S T R O W A L L</b></a></h4></div></center></body></html>'
    );
...
function prevqset(e) {
  ...
  if (reslt != "ID not found!") {
    ...
    document.getElementById("eduexmid").innerHTML = reslt[0].ExamID;
      ...
      for (var i = 0; i < len - 2; i++) {
        if (i == 0) {
          ...
          if (qsopsimg == "null") {
            var i1 = i + 1;
            document.getElementById("previewqset").innerHTML =
              "<div style='font-size:16px;padding-top:20px;padding:10px;' class='qsdivone'>" +
          ...
          if (qsopsimg == "null") {
            document.getElementById("previewqset").innerHTML +=
              ...
              "src='" +
              qsimg +
              "' onerror='this.onerror=null;this.style.display=`none`;this.style.display=`none`;'></div>" +
              "<div><p>A. " +
...
function clrqsetcomplete() {
  ...
  var url1 = "https://script.google.com/macros/s/";
  var url2 =
    "AKfycbwoJm4kSsAtJ5bkERkhFwQuWHnK_wpnuaOkv5fLux6fop_F8EHHajnPkFoIKU0HVCS4";
  var url =
    url1 +
    url2 +
    "/exec" +
...
function crnwexid(e) {
  ...
  var url1 = "https://script.google.com/macros/s/";
  var url3 =
    "AKfycbxO8NaomCMfuxi-gDCXZDPKZ-BdwNG241GHeqkxLGXWOgCj_CQE3GySZp9Nz_ffqrYFFQ";
  if (reslt != "ID not found!") {
    var k =
      "ep/" +
    ...
    document.getElementById("examidFin").innerHTML =
      "Exam ID: " +
      "<span style='background-color:#0c29cd;padding:4px 6px;font-style:italic;'>" +
      newid +
      "</span>";
    ...
    document.getElementById("studentpassdoc").innerHTML =
      ...
      "<span style='font-size:16px;color:#0c29cd;padding:4px 6px;'>" +
      title +
      " </span> " +
      "By " +
      " " +
      "<span style='font-size:18px;color:#0c29cd;padding:4px 6px;'>" +
      name +
      " </span>" +
      "|||||||||||||||||||||||||||</span>" +
      "</div><hr><hr>";
