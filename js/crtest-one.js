...
<p>Educator Name: <b><span class="exeduinfoid">` +
      res[0].EducatorName +
      `</span></b></p>
<p>Exam Title: <b><span class="exeduinfoid">` +
      res[0].ExamTitle +
      `</span></b></p>
<p>Description: <b><span class="exeduinfoid">` +
      res[0].ExamDescp +
      `</span></b></p>
<p>Test Duration: <b><span class="exeduinfoid">` +
      res[0].TDuration +
      `</span></b></p>
<p><span class="exdcrtedt">Exam ID: <b><span class="exeduinfoid">` +
      res[0].ExamID +
      `</span></b></span>
...
chresult.addEventListener("submit", (event) => {
  ...
  var url1 = "https://script.google.com/macros/s/";
  var url2 =
    "AKfycbxGHxUc-rfFOPKqRZr9GCLY7kWm3j1Aw5E9ejlT_8_HrQL2HPImBo-bcZ_4vUeiidh_";
  var url =
    url1 +
    url2 +
    "/exec" +
    "?callback=chkldrslt&chexid=" +
    exid +
    "&chenid=" +
    enid +
    "&action=chrslt";
    ...
    for (var k = 0; k < lenstr; k += 2) {
      if (enid == sprestr[k]) {
        ...
        for (var j = 0; j < lenstrkey - 1; j++) {
          ...
          if (resone.qnst[j] == "Not Answered") {
            ntansd = ntansd + 1;
          } else {
            ntansd = ntansd;
          }
          if (
            resone.qnst[j] != "Not Answered" &&
            resone.qnst[j] != anskey[j].substring(1)
          ) {
            wrng = wrng + 1;
          } else {
            wrng = wrng;
...
function ctrlqstex(e) {
  ...
  if (cat === "Value updated successfully!") {
    ...
    document.getElementById("assignstuexform").style.backgroundImage =
      "linear-gradient(0deg,white,white)";
    document.getElementById("enrolledinfo").innerHTML =
      "<div style='padding:20px;min-height:300px;font-family: verdana;' align='center'><div style='max-width:1000px;text-align:left;'>" +
      "<hr><p><span style='float:left;'><img src='https://mastrowall.com/images/logoRecBWsvg.svg' style='width:25px;'></span><span style='margin-left:5px;font-size:16px;color:#666666;'><b>M A S T R O W A L L | <a target='_blank' href='https://exam-portal.mastrowall.com/' style='text-decoration:none;color:#0c29cd;'>Exam Portal</a></b></a></span><span style='float:right;font-size:12px;'>" +
      currentTime +
      "</span></p><hr>" +
      "<br><p style='font-size:16px;'>Enrollment ID: <span style='color:#0c29cd;'><b>" +
      enid +
      "</b></span></p>" +
      "<p style='font-size:16px;'>Name: <b>" +
      namestu +
      "</b></p>" +
      "<p style='font-size:16px;'>Exam ID: <b>" +
      examid +
      "</b></p>" +
...
var optionsS = {
  ...
  handler: function (response) {
    ...
    var ur2 =
      "AKfycbwdJvI9tIbOZH6dzaSUjzot2NBIwYb0y_cM1iNAPYiMTJB6yIn7L7N2T0H7uBCruG5YQg";
    var url =
      ur1 +
      ur2 +
      "/exec" +
