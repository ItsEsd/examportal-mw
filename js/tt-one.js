...
function mrkfrrev(label) {
  ...
  document.getElementsByClassName("qstindex")[posofq].style.backgroundColor =
    "red";
}
...
function ansrdclrch(label) {
  ...
  if (val != "Not Answered") {
    document.getElementsByClassName("qstindex")[pos].style.backgroundColor =
      "green";
  } else {
    document.getElementsByClassName("qstindex")[pos].style.backgroundColor =
      "#f5cc14";
...
function submitans() {
  ...
  var url1 = "https://script.google.com/macros/s/";
  var url2 =
    "AKfycbyf8ZN_wYToG0ElRVSrGMvNslyr0hyPnUCbEt4SbnkLH20hMOUZS-L6HQwIrqS_vdYV";
  var url =
    url1 +
    url2 +
    "/exec" +
    "?callback=ctrlqus&chexid=" +
    exid +
    "&chpass=" +
    expass +
    "&chenid=" +
...
function ldstrslt(e) {
  ...
  if (res != "ID not found!") {
    ...
    var chartCanvas = document.getElementById("anchartans2");
